 ...
 */
public class TrieST_mod {
    private static final int R = 26;        // extended ASCII
    private static final String alph= "ABCDEFGHIJKLMNOPQRSTUVWXYX";
   ...
   /**
    ...
    private void collect(Node x, StringBuilder prefix, String pattern, Queue<String> results) {
        if (x == null) return;
        int d = prefix.length();
        if (d == pattern.length() && x.val != false)
    ...
    public static void main(String[] args) {
        ...
        TrieST_mod st = new TrieST_mod();
        for (int i = 0; i < 10 /*!StdIn.isEmpty()*/; i++) {
