...
public class BoggleBoard_normal {
     ...
     */
    public BoggleBoard_normal(String filename) {
     ...
     */
    public BoggleBoard_normal(int M, int N) {
        this.M = M;
        this.N = N;
        board = new char[M][N];
        for (int i = 0; i < M; i++) {
     ...
     */
    public BoggleBoard_normal(char[][] a) {
        this.M = a.length;
        this.N = a[0].length;
        board = new char[M][N];
        for (int i = 0; i < M; i++) {
    ...
    public static void main(String[] args) {
        ...
        BoggleBoard_normal board1 = new BoggleBoard_normal();
        ...
        BoggleBoard_normal board2 = new BoggleBoard_normal(4, 4);
        ...
        BoggleBoard_normal board3 = new BoggleBoard_normal(a);
        ...
        BoggleBoard_normal board4 = new BoggleBoard_normal(filename);
