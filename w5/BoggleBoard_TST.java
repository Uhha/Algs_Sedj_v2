...
public class BoggleBoard_TST {
     ...
     */
    public BoggleBoard_TST(String filename) {
     ...
     */
    public BoggleBoard_TST(int M, int N) {
        this.M = M;
        this.N = N;
        board = new char[M][N];
        for (int i = 0; i < M; i++) {
    ...
    public static void main(String[] args) {
        ...
        BoggleBoard_TST board1 = new BoggleBoard_TST();
        ...
        BoggleBoard_TST board2 = new BoggleBoard_TST(4, 4);
        ...
        BoggleBoard_TST board3 = new BoggleBoard_TST(a);
        ...
        BoggleBoard_TST board4 = new BoggleBoard_TST(filename);
