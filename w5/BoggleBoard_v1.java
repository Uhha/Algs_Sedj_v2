...
public class BoggleBoard_v1 {
     ...
     */
    public BoggleBoard_v1(String filename) {
     ...
     */
    public BoggleBoard_v1(int M, int N) {
        this.M = M;
        this.N = N;
        board = new char[M][N];
        for (int i = 0; i < M; i++) {
    ...
    public static void main(String[] args) {
        ...
        BoggleBoard_v1 board1 = new BoggleBoard_v1();
        ...
        BoggleBoard_v1 board2 = new BoggleBoard_v1(4, 4);
        ...
        BoggleBoard_v1 board3 = new BoggleBoard_v1(a);
        ...
        BoggleBoard_v1 board4 = new BoggleBoard_v1(filename);
